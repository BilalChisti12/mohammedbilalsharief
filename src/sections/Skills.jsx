...
import { SiPython, SiDocker, SiJavascript, SiMongodb, SiMysql, SiExpress, SiHtml5, SiNodedotjs, SiPostgresql, SiJsonwebtokens } from 'react-icons/si';
...
export default function Skills() {
  ...
  const skills = [
    ...
    { icon: <SiJsonwebtokens />, name: "JWT / REST APIs" },
  ];
...
' />
      ...
      >
        Java · Python · JavaScript · Full Stack MERN · Docker · Databases
      </motion.p>

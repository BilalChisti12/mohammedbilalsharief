        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            <h2 className="text-4xl sm:text-5xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-[#1CD8D2] via-[#00bf8f] to-[#302b63]">
              Mohammed Bilal Sharief
            </h2>
            <p className="mt-2 text-lg sm:text-xl text-white/90 font-semibold">
              Full Stack (MERN) Developer · GATE 2026 Qualified · Visakhapatnam, India
            </p>

            <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
              Final-year B.Tech CSE student at GITAM University (2023–2027). I build scalable, AI-driven full-stack applications using Java, Python, JavaScript, React.js, and Node.js — from conversational AI assistants to real-time video platforms and smart campus systems.
            </p>
            ...
            <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 max-w-xl">
              {[
                ...
                { label: "LeetCode Problems", value: "150+ Solved" },
                { label: "Focus", value: "AI-driven Scalable Systems" },
              ].map((item, i) => (
                <motion.div
                  key={i}
        ...
        <div className="grid md:grid-cols-1">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
              I'm a Final-year B.Tech Computer Science and Engineering student at GITAM University (2023–2027), skilled in DSA in Java and Python, Full Stack Development, and AI-driven application design. I've built real-world projects integrating the OpenAI API, WebRTC, Docker, and RESTful APIs from the ground up.
            </p>
            <p className="mt-4 text-gray-400 text-base sm:text-lg">
              GATE 2026 Qualified (CSIT) — national top-percentile. Completed Python, Data Science, and Applied AI coursework through Cisco Networking Academy. Actively solving DSA problems (150+ on LeetCode). Passionate about building scalable, user‑focused software that makes an impact.
            </p>
          </motion.div>
        </div>
      </div>

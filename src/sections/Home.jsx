...
const socials = [
  { Icon: FaLinkedinIn, label: "LinkedIn", href: "https://www.linkedin.com/in/mohammedbilalsharief/" },
  { Icon: FaInstagram, label: "Instagram", href: "#" },
  { Icon: FaGithub, label: "GitHub", href: "https://github.com/BilalChisti12" },
];
...
const Home = React.forwardRef((props, ref) => {
  const roles = useMemo(
    () => ["Full Stack (MERN) Developer", "Web Developer", "CCNA Certified", "Computer Networks Enthusiast", "GATE 2026 Qualified", "Software Developer"],
    []
  );
      ...
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
        ...
        >
          <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
            ...
            >
              I build scalable software that solves real-world problems from secure full-stack platforms and AI-powered applications to real-time systems built for performance and reliability.
            </motion.p>
